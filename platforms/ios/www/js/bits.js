...
var BITS = (function(){
    ...
    function getMessage(_userId, _canvas){
        ...
        var imgData = ctx.getImageData(0, 0, _canvas.width, _canvas.height);
        var _bitArray = [];
        var start = magicPixel;    //2017
        var len = getMsgLength(_canvas);   //64
        var end = magicPixel + len;  //2081
        ...
        //console.log('message array', _bitArray, _bitArray.length, len);               
    ...
    function stringToBitArray(_str){
        ...
        //console.log('twobytebufferview len', len);
        var _bitArray = [];
        for(var i=0; i<len; i++){
        ...
        //console.log('about to save bitarray', _bitArray)
        return _bitArray;
    }
    ...
    function bitArrayToString(_bitArray){
        ...
        for(var b=0; b<len; b=b+16){
            //console.log('getting letter', (b/16) );
            var num = 0;
            num = num |
                _bitArray[b] << 15 |
                _bitArray[b+1] << 14 |
